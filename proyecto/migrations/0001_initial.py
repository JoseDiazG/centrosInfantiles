# Generated by Django 2.1.3 on 2018-11-25 00:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=45)),
                ('canton', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='proyecto.Canton')),
            ],
        ),
        migrations.CreateModel(
            name='Persona',
        ...
        migrations.AddField(
            model_name='centro',
            name='parroquia',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='proyecto.Parroquia'),
        ),
        migrations.AddField(
            model_name='canton',
            name='provincia',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='proyecto.Provincia'),
        ),
        migrations.AddField(
            model_name='alumno',
            name='curso',
